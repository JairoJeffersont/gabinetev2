        ...
        <div class="container-fluid p-2">
            ...
            <div class="card mb-2">
                <div class="card-header bg-primary text-white px-2 py-1 custom-card-header">
                    <i class="bi bi-calendar"></i> Gerenciar situações de compromissos
                </div>
                <div class="card-body custom-card-body p-2">
                    <p class="card-text mb-0">
                        Nesta seção, é possível gerenciar as situações de compromissos do sistema, garantindo a organização correta dessas informações.
                    </p>
                </div>
            </div>
            ...
            <div class="card shadow-sm mb-2">
                <div class="card-body custom-card-body p-2">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['btn_salvar'])) {
                        ...
                        $result = $situacaoCompromissoController->inserir($dados);
                ...
                <div class="card-body custom-card-body p-2">
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered table-striped mb-0">
                            ...
                            <tbody>
                                <?php
                                $buscaTipos = $situacaoCompromissoController->listar('nome', 'asc', 1000, 1, ['gabinete' => [$_SESSION['gabinete'], '1']]);

                                if ($buscaTipos['status'] == 'success') {
                                    foreach ($buscaTipos['data'] as $tipos) {
                                        $usuario = $usuarioController->buscar($tipos['criado_por'])['data']['nome'];
                                        echo '<tr>
                                                <td><a href="?secao=situacao-compromisso&tipo=' . $tipos['id'] . '">' . $tipos['nome'] . '</a></td>
