...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid p-2">
            ...
            <div class="card mb-2">
                <div class="card-header bg-primary text-white px-2 py-1 custom-card-header"><i class="bi bi-people"></i> Editar tipo de pessoa</div>
                <div class="card-body custom-card-body p-2">
                    ...
                    <form class="row g-2 form_custom" id="form_novo" method="POST">
                        <div class="col-md-2 col-12">
                            <input type="text" class="form-control form-control-sm" name="pessoa_tipo_nome" placeholder="Nome do Tipo" value="<?= $buscaTipo['data']['nome'] ?>" required>
                        </div>
