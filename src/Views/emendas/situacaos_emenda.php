        ...
        <div class="container-fluid p-2">
            ...
            <div class="card mb-2">
                <div class="card-header bg-primary text-white px-2 py-1 custom-card-header">
                    <i class="bi bi-flag"></i> Adicionar Situação de Emenda
                </div>
                <div class="card-body custom-card-body p-2">
                    <p class="card-text mb-0">
                        Aqui você pode adicionar e gerenciar as situações de emendas cadastradas no sistema.
                    </p>
                </div>
            </div>
                ...
                <div class="card-body custom-card-body p-2">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['btn_salvar'])) {
                        $dados = [
                            ...
                            'descricao' => $_POST['situacao_descricao'],
                            'gabinete' => $_SESSION['gabinete'],
                            'criado_por' => $_SESSION['id']
                        ];

                        $result = $situacaoEmendaController->inserir($dados);
                    ...
                    if ($_SESSION['tipo'] != '1' && $_SESSION['tipo'] != '5') {
                        echo '<div class="alert alert-danger custom-alert px-2 py-1 mb-2">Você não tem autorização para inserir ou editar situações.</div>';
                    }
                    ?>
                    ...
                    <form class="row g-2 form_custom" method="POST">
                        ...
                        <div class="col-md-4 col-12">
                            <input type="text" class="form-control form-control-sm" name="situacao_descricao" placeholder="Descrição">
                        </div>
                        <div class="col-md-3 col-12">
                            <?php
                            if ($_SESSION['tipo'] == '1' || $_SESSION['tipo'] == '5') {
                            ...
                            <tbody>
                                ...
                                if ($lista['status'] == 'success') {
                                    foreach ($lista['data'] as $item) {
                                        ...
                                        echo '<tr>
                                                <td><a href="?secao=emenda-status&id=' . $item['id'] . '">' . $item['nome'] . '</a></td>
